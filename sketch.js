...
var star,star_img, star2,empty_star_img, empty_star;
var two_stars_img, two_stars;
function preload()
{
  ...
  empty_star_img = loadImage("g_star1.png");
  two_stars_img = loadImage("stars.png");
...
function setup() {
  ...
  star_display.addAnimation("empty",empty_star_img);
  star_display.addAnimation("one",star_img);
  star_display.addAnimation("two",two_stars_img);
